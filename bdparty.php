...
<body>
    ...
    <div style="background-color: #e0e0d1;">.
        <center>
            <p style="font-size:30px; height:40px; font-family: 'Acme', sans-serif;"> BIRTHDAY PARTY</p>
        </center>

        <center>
            <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                <a href="detaildress.php?name=BD1">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd1.jpg">
                    <p>BD 1</p>
                </div>
                </a>
                <a href="detaildress.php?name=BD2">
                    <div class="imgsameline">
                        <img style="width:300px; height:480px;" ; src="bd2.jpg">
                        <p>BD 2</p>
                    </div>
                </a>
                <a href="detaildress.php?name=BD3">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd4.jpg">
                    <p>BD 3</p>
                </div>
                </a>
            </div>
            <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                <a href="detaildress.php?name=BD4">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd3.jpg">
                    <p>BD 4</p>
                </div>
                </a>
                <a href="detaildress.php?name=BD5">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd5.jpg">
                    <p>BD 5</p>
                </div>
                </a>
                <a href="detaildress.php?name=BD6">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd6.jpg">
                    <p>BD 6</p>
                </div>
                </a>
            </div>
            <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                <a href="detaildress.php?name=BD7">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd7.jpg">
                    <p>BD 7</p>
                </div>
                </a>
                <a href="detaildress.php?name=BD8">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd8.jpg">
                    <p>BD 8</p>
                </div>
                </a>
                <a href="detaildress.php?name=BD9">
                <div class="imgsameline">
                    <img style="width:300px; height:480px;" ; src="bd9.jpg">
                    <p>BD 9</p>
                </div>
                </a>
            </div>
