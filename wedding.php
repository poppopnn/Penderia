    ...
    <div style="background-color:  #ccccb3; width: 100%; height:40px; padding-top: 20px; font-family: 'Rajdhani', sans-serif"
        ...
        <center>
            ...
            <div  style="background-color: #e0e0d1;">.
             <center>
                    <p style="font-size:30px; height:40px; font-family: 'Acme', sans-serif;"> WEDDING </p>
             </center>  
    
                <center>
                        <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                                <a href="detaildress.php?name=wed1">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed2.jpg">
                                    <p>WED 1</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=wed2">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed3.jpg">
                                    <p>WED 2</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=wed3">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed4.jpg">
                                    <p>WED 3</p>
                                </div>
                                </a>
                        </div>
                        <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                                <a href="detaildress.php?name=wed4">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed7.jpg">
                                    <p>WED 4</p>
                                </a>
                                <a href="detaildress.php?name=wed5">
                                </div>
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed8.jpg">
                                    <p>WED 5</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=wed6">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="wed9.jpg">
                                    <p>WED 6</p>
                                </div>
                                </a>
                        </div>
