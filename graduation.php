    ...
    <div style="background-color:  #ccccb3; width: 100%; height:40px; padding-top: 20px; font-family: 'Rajdhani', sans-serif"
        ...
        <center>
            ...
            <div  style="background-color: #e0e0d1;">.
             <center>
                    <p style="font-size:30px; height:40px; font-family: 'Acme', sans-serif;"> GRADUATION</p>
                </center>  
    
                <center>
                        <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                               <a href="detaildress.php?name=GD1">
                                <div class="imgsameline">
                                    <img style="width:300px; height: 400px;"; src="gra1.jpg">
                                    <p>GRADUATION 1</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=GD2">
                                <div class="imgsameline">
                                    <img style="width:300px; height: 400px;"; src="gra2.jpg">
                                    <p>GRADUATION 2</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=GD3">
                                <div class="imgsameline">
                                    <img style="width:300px; height: 400px;"; src="gra3.jpg">
                                    <p>GRADUATION 3</p>
                                </div>
                                </a>
                        </div>
                        <div style="font-family: 'Rajdhani', sans-serif; font-size: 25px;">
                                <a href="detaildress.php?name=GD4">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="gra7.jpg">
                                    <p>GRADUATION 4</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=GD5">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="gra5.jpg">
                                    <p>GRADUATION 5</p>
                                </div>
                                </a>
                                <a href="detaildress.php?name=GD6">
                                <div class="imgsameline">
                                    <img style="width:300px; height:480px;"; src="gra6.jpg">
                                    <p>GRADUATION 6</p>
                                </div>
                                </a>
                        </div>
